...
function updateDatabaseA(data){
    //var answer = [];
    var ans = document.getElementById('answer').value;
    var name = document.getElementById('nameText').textContent;
    //questions.push({"answer": ans})
    console.log(name);
    
    var resp = {id: 0, "answer": ans, "playerName":name};
    socket.emit('submitAnswerA', resp);
    
    console.log("updated");
    window.location.href="/player/waiting/index.html";  
